...
function chargerZoneItem() {
	...
	xhr.open("POST", "http://localhost:56408/GestionStockProduit4.asmx/getProducts", false);
	xhr.send();
...
function afficherDetail(unProduit){
	...
	//document.querySelector("#unDetail").innerHTML = unProduit.duree + unProduit.plateforme + unProduit.isbn + unProduit.auteur;
	 if (duree != null)
    {
    ...
    {
        document.querySelector("#unDetail").innerHTML = unProduit.plateforme;
    }
   else if(isbn != null)
    {
        document.querySelector("#unDetail").innerHTML = "ISBN: " + unProduit.isbn + " Auteur: " + unProduit.auteur;
    }               
...
function signOut() {
	...
	location.href = "http://localhost:56408/Login.html";
}